...
public class LIBParserStrategyTest {
    ...
    public void setupMenus() {
        MenuParserStrategy strategy = new LIBParserStrategy();
    ...
    public void testMenuItemsListSizeIsCorrect() {
        assertEquals(7, menus.get(0).getMenuItems().size());
    }
    ...
    public void testMenuCorrectDateParsed() {
        assertEquals(LocalDate.of(2018, 4, 8), menus.get(0).getDate());
    }
